...
2. Instalar Visual Studio Code, Node JS
...
3. Instalar Cypress
  ...
  - Seleccionar si queremos instalar varios ejemplos de cypress o un único file con el cual se va a abrir el cypress, en este caso seleccionamos "Create new spec"
...
4. Crear el archivo de compra online
  - En el "Visual Studio Code", vamos a la carpeta que creamos "CompraOnline"
  - Ir al path: cypress/e2e y hacemos click derecho "New File" y creamos un archivo llamado "compraonline.cy.js"
  - En el archivo "compraonline.cy.js" se encuentra todo el código para generar el automation testing de la compra online.
